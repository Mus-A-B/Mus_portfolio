...
- The mysql queries used to explore the menu items table can be found [here](restaurant%20orders%20obj1.sql)
- The mysql queries used to explore the orders table can be found [here](restaurant%20orders%20obj2.sql)
- The mysql queries used to comnbine and explore the combine tables can be found [here](restaurant%20orders%20obj3.sql)
---
